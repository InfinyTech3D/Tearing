...
void registerTearingEngine(sofa::core::ObjectFactory* factory)
{
    factory->registerObjects(sofa::core::ObjectRegistrationData("Tearing engine.")
        .add< TearingEngine<Vec3Types> >());
}
