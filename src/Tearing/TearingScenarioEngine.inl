...
template <class DataTypes>
void TearingScenarioEngine<DataTypes>::doUpdate()
{
...
template <class DataTypes>
void TearingScenarioEngine<DataTypes>::triangleOverThresholdPrincipalStress()
{
...
template <class DataTypes>
void TearingScenarioEngine<DataTypes>::updateTriangleInformation()
{
...
template<class DataTypes>
inline void TearingScenarioEngine<DataTypes>::computeFractureDirection(Coord principleStressDirection,Coord & fracture_direction)
{
    if (m_maxStressTriangleIndex == InvalidID) {
...
template<class DataTypes>
inline bool TearingScenarioEngine<DataTypes>::computeEndPointsNeighboringTriangles(Coord Pa, Coord direction, Coord& Pb, Coord& Pc)
{
...
template<class DataTypes>
inline bool TearingScenarioEngine<DataTypes>::computeIntersectionNeighborTriangle(Coord normalizedFractureDirection,Coord Pa ,Coord& Pb, Real& t)
{
    SOFA_UNUSED(Pa);
    helper::ReadAccessor< Data<VecCoord> > x(d_input_positions);
...
template<class DataTypes>
inline bool TearingScenarioEngine<DataTypes>::rayTriangleIntersection(Coord A, Coord C, Coord D, Coord direction, Real& t,Coord& intersection)
{
    const auto AC = C - A;
...
template <class DataTypes>
void TearingScenarioEngine<DataTypes>::computeTriangleToSkip()
{
    helper::WriteAccessor< Data<vector<Index>> >triangleToSkip(d_trianglesToIgnore);
...
template<class DataTypes>
inline void TearingScenarioEngine<DataTypes>::processTjunctionTriangle(const vector<vector<int>>& TjunctionTriangle, helper::WriteAccessor<Data<vector<Index>>>& triangleToSkip)
{
...
template<class DataTypes>
inline Index TearingScenarioEngine<DataTypes>::computeVertexByArea_WeightedAverage(const Triangle& selectedTriangle)
{
    helper::ReadAccessor< Data<VecTriangleFEMInformation> > triangleFEMInf(m_triangularFEM->triangleInfo);
...
template<class DataTypes>
inline Index TearingScenarioEngine<DataTypes>::computeVertexByUnweightedAverage(const Triangle& selectedTriangle)
{
    helper::ReadAccessor< Data<VecTriangleFEMInformation> > triangleFEMInf(m_triangularFEM->triangleInfo);
...
template<class DataTypes>
inline Index TearingScenarioEngine<DataTypes>::computeVertexByInverseDistance_WeightedAverage(const Triangle& selectedTriangle)
{
    helper::ReadAccessor< Data<VecTriangleFEMInformation> > triangleFEMInf(m_triangularFEM->triangleInfo);
...
template<class DataTypes>
inline void TearingScenarioEngine<DataTypes>::calculate_inverse_distance_weights(std::vector<double>& result,
