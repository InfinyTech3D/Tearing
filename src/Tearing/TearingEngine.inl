...
void TearingEngine<DataTypes>::computeTriangleToSkip()
{
    ...
    this->getContext()->template get< typename constantFF >(&_constantForceFields, sofa::core::objectmodel::BaseContext::SearchUp);

    vector<fixC*> _fixConstraints;
    this->getContext()->template get< typename fixC >(&_fixConstraints, sofa::core::objectmodel::BaseContext::SearchUp);
